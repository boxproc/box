...
export const defaultSchedulerJobsSelector = (state: IStoreState) => state.admin.scheduler.scheduler;
...
export const defaultInstSchedulerNamesOptions = (state: IStoreState) =>
  state.admin.scheduler.schedulerNames;
