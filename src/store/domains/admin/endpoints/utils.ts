...
export const prepareFilterToSend = (data: Partial<IEndpointsFilter>) => {
  if (!data) {
    return null;
  }
...
export const prepareDataToSend = (data: Partial<IEndpointDetails>) => {
  if (!data) {
    return null;
  }
...
export const prepareDataToRender = (data: Partial<IEndpointData>, institution?: ISelectValue) => {
  if (!data) {
    return null;
  }
...
export const prepareDetailsToRender = (data: Partial<IEndpointData>) => {
  if (!data) {
    return null;
  }
