import { IAuthResp, IAuthStepTwoResp, IUserInstitutionsData } from './types';

import { IResponseStatus } from 'types';

export const authResponseMock: IAuthResp = {
  session_id: '123',
  first_name: 'John',
  last_name: 'Doe',
  username: 'admin',
...
export const authSecretKeyMock: IAuthStepTwoResp = {
...
export const userInstitutionsMock: IUserInstitutionsData = {
  institutions: [
    {
      id: 1,
