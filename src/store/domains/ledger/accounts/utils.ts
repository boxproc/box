...
export const preparedValuesToSend = (values: Partial<LedgerAccountItemDetailsPrepared>) => {
  ...
  return {
    ...
    customer_id: values.customerId && Number(values.customerId),
    ...
    balance_settled: values.balanceSettled && Number(values.balanceSettled),
    balance_available: values.balanceAvailable && Number(values.balanceAvailable),
    amount_due_repayment: values.amountDueRepayment && Number(values.amountDueRepayment),
    balance_limit: values.balanceLimit && Number(values.balanceLimit)
      && Number(values.balanceLimit),
    balance_limit_shared: values.balanceLimitShared && Number(values.balanceLimitShared),
    accrued_interest: values.accruedInterest && Number(values.accruedInterest),
    ...
    aux_counter_1: values.auxCounter1 && Number(values.auxCounter1),
    aux_counter_2: values.auxCounter2 && Number(values.auxCounter2),
    aux_counter_3: values.auxCounter3 && Number(values.auxCounter3),
    amount_overdue: values.amountOverdue && Number(values.amountOverdue),
    amount_overdue_1_cycle: values.amountOverdue1Cycle && Number(values.amountOverdue1Cycle),
    amount_overdue_2_cycles: values.amountOverdue2Cycles && Number(values.amountOverdue2Cycles),
    amount_overdue_3_cycles: values.amountOverdue3Cycles && Number(values.amountOverdue3Cycles),
    amount_overdue_4_cycles: values.amountOverdue4Cycles && Number(values.amountOverdue4Cycles),
    amount_overdue_5_cycles: values.amountOverdue5Cycles && Number(values.amountOverdue5Cycles),
    amount_overdue_6_cycles: values.amountOverdue6Cycles && Number(values.amountOverdue6Cycles),
    amount_overdue_7_cycles: values.amountOverdue7Cycles && Number(values.amountOverdue7Cycles),
    number_of_times_overdue_total: values.numberOfTimesOverdueTotal
      && Number(values.numberOfTimesOverdueTotal),
    number_of_times_overdue_1_cycle: values.numberOfTimesOverdue1Cycle
      && Number(values.numberOfTimesOverdue1Cycle),
    number_of_times_overdue_2_cycle: values.numberOfTimesOverdue2Cycles
      && Number(values.numberOfTimesOverdue2Cycles),
    number_of_times_overdue_3_cycle: values.numberOfTimesOverdue3Cycles
      && Number(values.numberOfTimesOverdue3Cycles),
    number_of_times_overdue_4_cycle: values.numberOfTimesOverdue4Cycles
      && Number(values.numberOfTimesOverdue4Cycles),
    number_of_times_overdue_5_cycle: values.numberOfTimesOverdue5Cycles
      && Number(values.numberOfTimesOverdue5Cycles),
    number_of_times_overdue_6_cycle: values.numberOfTimesOverdue6Cycles
      && Number(values.numberOfTimesOverdue6Cycles),
    number_of_times_overdue_7_cycle: values.numberOfTimesOverdue7Cycles
      && Number(values.numberOfTimesOverdue7Cycles),
  };
};
...
export const preparedValuesToRender = (values: Partial<LedgerAccountItem>) => {
  ...
  return {
    ...
    customerId: values.customer_id && Number(values.customer_id),
