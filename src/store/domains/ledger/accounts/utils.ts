...
export const prepareDataToSend = (data: Partial<IAccountDetails>) => {
  ...
  return {
    ...
    num_interest_free_instlmts: stringsUtil.toNumber(numInterestFreeInstlmts),
    ...
    direct_debit_mandate_id: directDebitMandateId && directDebitMandateId.value,
  };
};
...
export const prepareDataToRender = (data: Partial<IAccountData>, institution?: ISelectValue) => {
  ...
  return {
    ...
    numInterestFreeInstlmts: num_interest_free_instlmts,
